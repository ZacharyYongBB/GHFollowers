...
class SearchViewController: UIViewController {
    ...
    let callToActionButton = CustomButton(color: .systemGreen, title: "Get Followers", systemImageName: "person.3")
    ...
    func configureLogoImageView() {
        ...
        logoImageView.image = ImagesNamed.ghLogo
        
        let topConstraintConstant: CGFloat = DeviceTypes.isiPhoneSE || DeviceTypes.isiPhone8Zoomed ? 20 : 80
        
        logoImageViewTopConstraints = logoImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: topConstraintConstant)
